...
const textareaClass =
  "mt-2 w-full rounded-xl border border-edge bg-scrim px-4 py-3 text-base leading-relaxed text-[var(--color-paper)] transition placeholder:text-[var(--color-paper-faint)] focus:border-[color-mix(in_oklab,var(--color-lime-glow)_45%,transparent)] disabled:opacity-60";

const selectClass =
  "mt-2 w-full rounded-xl border border-edge bg-scrim px-4 py-3 text-base text-[var(--color-paper)] transition focus:border-[color-mix(in_oklab,var(--color-lime-glow)_45%,transparent)] disabled:opacity-60 sm:w-auto";
