    ...
    <form onSubmit={submit} className="card p-6 sm:p-8" noValidate>
      <div>
        ...
        <textarea
          ...
          className="mt-2.5 w-full resize-none rounded-xl border border-edge bg-scrim px-4 py-3 text-base leading-relaxed text-[var(--color-paper)] placeholder:text-[var(--color-paper-faint)] transition focus:border-[color-mix(in_oklab,var(--color-lime-glow)_45%,transparent)] disabled:opacity-60"
        />
