...
const cs: MotivationPiece[] = [
  ...
  {
    title: "Tenhle den existuje jen jednou",
    paragraphs: [
      "Ahoj,",
      "zastav se na chvíli. Právě teď, v téhle vteřině celých dějin vesmíru, existuje jen jeden jediný den, který vypadá přesně takhle. Světlo, které ti dopadá do okna. Ta konkrétní směsice lidí, co ti dnes zkříží cestu. Myšlenky, které jsou ti dnes po ruce. Šance, které se otevřou a zase zavřou. Nic z toho tu nikdy přesně takhle nebylo a nikdy přesně takhle nebude.",
      "A teď to podivuhodnější — a není to o tom, že se dnešek nebude opakovat. Většinu času se totiž měříme podle ostatních. Co je běžné. Co se v našem věku čeká. Kdo už co má za sebou. Jako by ve světě byla vyříznutá mezera zhruba našeho tvaru a naším úkolem bylo do ní zapadnout tak, aby to sedělo.",
      "Ta mezera nikde není. Nikdo ji nevyřízl a nikdo podle ní neměří. Je pomyslná — a přitom v hlavě drží jako přibitá. A dokud tam je, bere ti dvě věci najednou: tvoji jedinečnost a tvoji skutečnou volbu. Všechno se nejdřív poměří s davem a teprve pak se smí počítat.",
      "Zkus si ji dnes na chvíli odmyslet. Ne vzdorem, prostě se na to podívej znovu. Co zbude, je tohle: ty se vším, co k tobě patří, v téhle minutě, s tímhle konkrétním pohledem na věc. Ne exemplář. Originál. A dnešek v tvém podání je pak originál taky — něco vzácného, co ti leží v ruce.",
      "A ten den se ti neděje. Píšeš ho.",
      "Každá dnešní volba — ty tiché i ty odvážné — je tah štětcem na plátně, které existuje jen jednou. Slova, která řekneš nebo zamlčíš. Pozornost, kterou věnuješ nebo odepřeš. Malé činy odvahy nebo laskavosti. To, jak zareaguješ, když se objeví něco nečekaného. Tím vším píšeš kapitolu, kterou po tobě nikdo jiný nepřepíše.",
      "Tak si dnes ráno ten úžas připusť. Máš před sebou den, jaký ještě nebyl, a potkáš se s ním jako nikdo jiný — ne jako náhrada za někoho, kdo to má umět líp. Jaký tón mu dáš? Co v něm vznikne, co by odnikud jinud vzniknout nemohlo?",
      "Nemusí být dokonalý. Stačí do něj vstoupit jako ty a nikdo jiný, a utvářet ho s pozorností a záměrem.",
      "Tenhle den je tvůj. Nikdo jiný ho za tebe neutváří — a je v něm mnohem víc prostoru, než kolik ti pomyslná šablona dovolí vidět.",
...
const en: MotivationPiece[] = [
  ...
  {
    title: "This day exists only once",
    paragraphs: [
      "Hello,",
      "stop for a moment. Right now, in this second of the entire history of the universe, there is only one day that looks exactly like this. The light falling through your window. The particular mix of people who will cross your path today. The thoughts within reach today. The chances that will open and close again. None of it has ever been quite like this and none of it ever will be again.",
      "And now the stranger part — and it is not that today will never come again. Most of the time we measure ourselves against everyone else. What is normal. What is expected at our age. Who already has what behind them. As though the world held a gap cut roughly to our shape, and our job were to fit into it neatly.",
      "That gap is nowhere. Nobody cut it and nobody measures by it. It is imagined — and yet it holds in the mind as though nailed down. And while it is there it takes two things from you at once: your singularity and your real choice. Everything gets weighed against the crowd first, and only then is it allowed to count.",
      "Try setting it aside for a moment today. Not out of defiance, just look again. What is left is this: you, with everything that belongs to you, in this minute, with this particular way of seeing. Not a specimen. An original. And today, in your rendering, is an original too — something rare, lying in your hand.",
      "And this day is not happening to you. You are writing it.",
      "Every choice today — the quiet ones and the bold ones — is a brushstroke on a canvas that exists only once. The words you say or hold back. The attention you give or withhold. The small acts of courage or kindness. The way you answer when something unexpected shows up. With all of it you are writing a chapter no one else will rewrite after you.",
      "So this morning, let that wonder in. Ahead of you is a day that has never happened, and you will meet it as no one else would — not as a stand-in for someone supposed to do it better. What tone will you give it? What will come into being in it that could have come from nowhere else?",
      "It does not have to be perfect. It is enough to step into it as you and nobody else, and shape it with attention and intent.",
      "This day is yours. No one else shapes it for you — and there is far more room in it than an imagined template will let you see.",
...
const de: MotivationPiece[] = [
  ...
  {
    title: "Diesen Tag gibt es nur einmal",
    paragraphs: [
      "Hallo,",
      "halte einen Moment inne. Genau jetzt, in dieser Sekunde der ganzen Geschichte des Universums, gibt es nur einen einzigen Tag, der genau so aussieht. Das Licht, das durch dein Fenster fällt. Die besondere Mischung von Menschen, die dir heute begegnen. Die Gedanken, die dir heute zur Hand sind. Die Chancen, die sich öffnen und wieder schließen. Nichts davon war je genau so, und nichts davon wird je wieder genau so sein.",
      "Und jetzt das Erstaunlichere — und es geht nicht darum, dass dieser Tag nie wiederkommt. Die meiste Zeit messen wir uns nämlich an den anderen. Was normal ist. Was man in unserem Alter erwartet. Wer schon was hinter sich hat. Als gäbe es in der Welt eine Lücke, grob in unserer Form ausgeschnitten, und unsere Aufgabe wäre, sauber hineinzupassen.",
      "Diese Lücke gibt es nirgends. Niemand hat sie ausgeschnitten und niemand misst danach. Sie ist gedacht — und hält im Kopf trotzdem wie festgenagelt. Und solange sie da ist, nimmt sie dir zweierlei auf einmal: deine Einzigartigkeit und deine echte Wahl. Alles wird erst an der Menge gemessen und darf erst dann zählen.",
      "Versuch sie heute einen Moment beiseitezulassen. Nicht aus Trotz, schau einfach noch einmal hin. Was bleibt, ist das: du, mit allem, was zu dir gehört, in dieser Minute, mit genau diesem Blick auf die Dinge. Kein Exemplar. Ein Original. Und der heutige Tag in deiner Fassung ist dann auch eines — etwas Kostbares, das dir in der Hand liegt.",
      "Und dieser Tag passiert dir nicht. Du schreibst ihn.",
      "Jede Wahl von heute — die stillen und die mutigen — ist ein Pinselstrich auf einer Leinwand, die es nur einmal gibt. Die Worte, die du sagst oder zurückhältst. Die Aufmerksamkeit, die du gibst oder verweigerst. Die kleinen Akte von Mut oder Güte. Die Art, wie du antwortest, wenn etwas Unerwartetes auftaucht. Mit alldem schreibst du ein Kapitel, das nach dir niemand neu schreibt.",
      "Lass also heute Morgen dieses Staunen herein. Vor dir liegt ein Tag, den es nie gab, und du begegnest ihm wie niemand sonst — nicht als Ersatz für jemanden, der es besser können soll. Welchen Ton gibst du ihm? Was entsteht in ihm, das von nirgendwo sonst hätte kommen können?",
      "Er muss nicht perfekt sein. Es genügt, als du und niemand sonst hineinzugehen und ihn mit Aufmerksamkeit und Absicht zu gestalten.",
      "Dieser Tag gehört dir. Niemand sonst gestaltet ihn für dich — und es ist weit mehr Raum darin, als eine gedachte Schablone dich sehen lässt.",
