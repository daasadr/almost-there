...
const cs: MotivationPiece[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "A teď to podivuhodnější. Nikdo v celém vesmíru dnešek necítí tak jako ty. Tvoje ráno má tvoji chuť a tvoje ticho. Vybaví se ti vzpomínky, které se nevybaví nikomu jinému. To, co se ti dnes honí hlavou, se v téhle podobě nehoní nikde jinde — a nebude to mít ani ten člověk, kterým budeš za rok.",
      "Tohle místo, tahle minuta a ty v ní. Jediné vydání, jaké kdy bude.",
      ...
      "Tak si dnes ráno tu váhu i ten zázrak připusť. Máš před sebou den, jaký ještě nebyl, a potkáš se s ním jako někdo, kdo je tu jen jednou. Jaký tón mu dáš? Co v něm vznikne, co by v žádný jiný den a od nikoho jiného vzniknout nemohlo?",
      "Nemusí být dokonalý. Stačí do něj vstoupit jako ty a nikdo jiný, a utvářet ho s pozorností a záměrem.",
      "Tenhle den je tvůj. Nikdo jiný ho za tebe neutváří a nikdo jiný už tu příležitost nedostane.",
...
const en: MotivationPiece[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "And now the stranger part. Nobody in the whole universe feels today the way you feel it. Your morning has your taste in it, and your silence. Memories will surface for you that will surface for no one else. What is going through your head today is going through nobody else\u2019s in this form — and it will not belong to the person you will be a year from now either.",
      "This place, this minute, and you in it. The only edition there will ever be.",
      ...
      "So this morning, let the weight and the wonder of that in. Ahead of you is a day that has never happened, and you will meet it as someone who is here only once. What tone will you give it? What will come into being in it that could have come from no other day and no one else?",
      ...
      "This day is yours. No one else shapes it for you, and no one else will ever get the chance.",
...
const de: MotivationPiece[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Und jetzt das Erstaunlichere. Niemand im ganzen Universum spürt diesen Tag so wie du. Dein Morgen hat deinen Geschmack und deine Stille. Dir werden Erinnerungen kommen, die sonst niemandem kommen. Was dir heute durch den Kopf geht, geht in dieser Form niemandem sonst durch den Kopf — und auch dem Menschen nicht, der du in einem Jahr sein wirst.",
      "Dieser Ort, diese Minute und du darin. Die einzige Ausgabe, die es je geben wird.",
      ...
      "Lass also heute Morgen das Gewicht und das Wunder davon herein. Vor dir liegt ein Tag, den es nie gab, und du begegnest ihm als jemand, der nur einmal hier ist. Welchen Ton gibst du ihm? Was entsteht in ihm, das an keinem anderen Tag und von niemandem sonst hätte entstehen können?",
      ...
      "Dieser Tag gehört dir. Niemand sonst gestaltet ihn für dich, und niemand sonst bekommt je die Gelegenheit.",
