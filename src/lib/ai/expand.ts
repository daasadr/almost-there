...
- Use whatever the person told you they have — the named textbook, the course, the equipment, the place. Those are what turn "go through the material" into "read the section on powers and work exercises 12 to 21". When you were given nothing specific, do not invent a source that may not exist; describe the work itself instead.
